...
<div class="container" style="margin-top: 30px">
    ...
    <div class="row">
       <nav aria-label="...">
  <ul class="pager">
 <li><a href="javascript:nextPage2(${pageBean.pageNow-1})" " class="glyphicon glyphicon-backward"> 上一页</a></li>&nbsp
    <li><a href="javascript:nextPage2(${pageBean.pageNow+1})" class="glyphicon glyphicon-forward"> 下一页</a></li>
  </ul>
</nav>
    </div>
 </div>
