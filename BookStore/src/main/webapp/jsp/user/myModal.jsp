...
function loginSubmit() {
    var lousername=document.getElementById("lousername");
    var lopassword=document.getElementById("lopassword");
    ...
    xmlhttp.onreadystatechange= function () {
           if(xmlhttp.readyState==4)
               ...
               if(s=="0"){
                   ...
                   flag=true;
                   window.location="${path}/jsp/book/index.jsp"
                 }
                }
    }
      xmlhttp.open("get","${path}/user/login?lousername="+lousername.value+"&lopassword="+lopassword.value+"&rem="+rem.value,true);
      xmlhttp.send();
      return flag;
}
</script> 
