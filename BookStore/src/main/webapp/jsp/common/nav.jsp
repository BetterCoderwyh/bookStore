		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse"
				...
				<ul class="nav navbar-nav">
					<li class="active"><a href="${path}/jsp/book/index.jsp">首页<span
					...
					<c:if test="${!empty user }">
					<li><a href="${path}/myorder/list">我的订单</a></li>
					<li><a href="${path}/jsp/cart/mycart.jsp"><span class="glyphicon glyphicon-shopping-cart"></span>我的购物车</a></li>
					</c:if>
					   <li class="dropdown">
  ...
  <!-- Wrapper for slides -->
        <div class="carousel-inner" role="listbox">
           <div class="item active">
              <img src="${path}/img/advert1.jpg" alt="...">
                  <div class="carousel-caption">
                 ... 
                  </div>
            </div>
           <div class="item">
              <img src="${path}/img/advert2.jpg" alt="...">
                  <div class="carousel-caption">
                ...
                  </div>
            </div>
           <div class="item">
              <img src="${path}/img/advert3.jpg" alt="...">
                  <div class="carousel-caption">
                ...
                 </div>
                </div>
