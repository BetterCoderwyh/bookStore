...
<%--  <%@ include file="../common/pageBean.jsp" %> --%>
    ...
    $(function() {
        $("#book1").load("${path}/book/jingxuanlist");
    });
    $(function() {
        $("#book2").load("${path}/book/tuijianlist");
    });
    $(function() {
        $("#book3").load("${path}/book/tejialist");
    });
    function nextPage1(param){
        $("#book1").load("${path}/book/jingxuanlist",{"pageNow":param});
    }
    function nextPage2(param){
        $("#book2").load("${path}/book/tuijianlist",{"pageNow":param});
    }
    function nextPage3(param){
        $("#book3").load("${path}/book/tejialist",{"pageNow":param});
    }
    function booklist(styleId,bookName,pageSize,pageNow){
        ...
        $("#list").load("${path}/book/booklist",{"styleId":styleId,"bookName":bookName,"pageSize":pageSize,"pageNow":pageNow});
