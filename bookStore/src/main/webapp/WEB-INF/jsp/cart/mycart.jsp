...
<link rel="stylesheet" type="text/css" href="${path}/dict/css/index.css" />
<link rel="stylesheet" type="text/css" href="${path}/dict/css/cart.css" />
<link rel="stylesheet" type="text/css" href="${path}/dict/css/animate.css" />
<title></title>
</head>
<body onload="changeNum()">
 ...
 <%@include file="../common/nav.jsp" %>
        ...
        <div class="container">
                    ...
                    <table class="table table-hover table-striped" style="vertical-align:middle;">
                        ...
                        <c:forEach items="${cart.cart}" var="o">
                            <tr>
                                ...
                                <td>${o.itemId}</td>
                                <td >${o.book_isbn}</td>
                                <td><img src="${path}/dict/img/${o.book_imgurl}"></td>
                                <td>${o.book_name}</td>
            ...
            maxFractionDigits="3" value="${cart.totalprice}"/>元</td>
                            ...
                            <tr style="background-color: white;">
                                <td>
                                    <a href="${path}/index" class="btn btn-info">&lt;&lt;继续购买</a>
                                </td>
                                <td>
                ...
                <div>
                    ...
                    <div class="row" id="love">
                        <div class="col-sm-12 col-md-12 wow fadeInRight animated">
                            <div class="thumbnail">
                                <a href="details.html"><img src="${path}/dict/img/cikehuakai.jpg " style="height: 200px; " alt="通用的占位符缩略图 "></a>
                                <div class="caption ">
                                    <h3>此刻花开</h3>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-12 col-md-12 wow fadeInRight animated">
                            <div class="thumbnail ">
                                <a href="details.html"><img src="${path}/dict/img/jindumanbu.jpg " style="height: 200px; " alt="通用的占位符缩略图 "></a>
                                <div class="caption ">
                                    <h3>京都漫步</h3>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-12 col-md-12 wow fadeInRight animated">
                            <div class="thumbnail ">
                                <a href="details.html"><img src="${path}/dict/img/lapulasidemonv.jpg" style="height: 200px; " alt="通用的占位符缩略图 "></a>
                                <div class="caption ">
                                    <h3>拉普拉斯的魔女</h3>
                                </div>
                            </div>
                    ...
                    <div class="col-md-offset-2 col-md-8">
                        <div class="row ">
                            <div class="col-md-offset-2 col-md-2">
                                <img src="${path}/dict/img/logo.png ">
                            </div>
                            <div class="col-md-6">
                                <div class="row">
    ...
    <script type="text/javascript" src="${path}/dict/js/wow.js"></script>
    <script src="${path}/dict/dist/js/distpicker.data.min.js"></script>
        <script src="${path}/dict/dist/js/distpicker.min.js"></script>
    <script src="${path}/dict/js/cart.js" type="text/javascript" charset="utf-8"></script>
    <script src="${path}/dict/js/confirm_order.js"></script>
     <script type="text/javascript">
    $(function() {
        $("#nav").load("${path}/book/navlist");
    });
